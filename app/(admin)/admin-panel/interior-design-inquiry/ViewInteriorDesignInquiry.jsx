...
const ViewInteriorDesignInquiry = ({ data }) => {
    return (
        <>
            <Form>
                <Container>
                    ...
                    <Row>
                        ...
                        <Col md={6} className="mb-2">
                            <Form.Group controlId="formInteriorType">
                                <Form.Label>Interior Type</Form.Label>
                                <Form.Control type="text" disabled value={data?.interiorType} />
                            </Form.Group>
                        </Col>
                    </Row>
                    <Row>
...
export default ViewInteriorDesignInquiry;
