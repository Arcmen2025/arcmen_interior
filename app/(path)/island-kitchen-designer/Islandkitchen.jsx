...
export default function Islandkitchen() {
    return (
        <div>
            <section className="islandkitchen-banner">
                <Container>
                    <Row>
                        <Col className="text-center">
                            <h1>ISLAND KITCHEN DESIGN</h1>
            ...
            <section>
                <Container>
                    <Row>
                        <Col sm={12} md={4} lg={4} className="islandkitchen-card">
                            <div className="card">
                                <div className="">
            ...
            <section>
                <Container>
                    <Row>
                        <Col sm={12} md={12} lg={4} className="islandkitchen-textcard">
                            <div className="d-flex flex-column flex-sm-row ">
                                <div className="box-1 flex-fill text-center">FINISH</div>
                                <div className="box-2 flex-fill">Glass, Acrylic, PU Wooden, Glossy</div>
                            </div>
                        </Col>
                        <Col sm={12} md={12} lg={4} className="islandkitchen-textcard">
                            <div className="d-flex flex-column flex-sm-row ">
                                <div className="box-1 flex-fill text-center">TEXTURE</div>
            ...
            <section>
                <Container>
                    <Row>
                        <Col sm={12} md={6} lg={4} className="islandkitchen-image">
