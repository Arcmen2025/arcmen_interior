...
import './ecoduramodular.css';
import { Col, Container, Row } from 'react-bootstrap';
import Link from 'next/link';

export default function Ecoduramodular() {
    return (
        <div>
            <section className="ecoduramodular-banner">
                <Container>
                    <Row>
                        <Col className="text-center">
                            <h1>ECODURA MODULAR KITCHEN</h1>
                            <p>Affordable, Durable, Simple yet Stunning: The laminated “Ecodura” range offers Unlimited Shades & Finish, offers to a without expensive price tag.</p>
            ...
            <section>
                <Container>
                    <Row>
                        <Col xs={12} sm={12} md={4} lg={4} className="ecoduramodular-card">
                            <div className="card">
                                <div className="">
            ...
            <section>
                <Container>
                    <Row>
                        <Col xs={12} sm={12} md={6}  lg={6} className="ecoduramodular-textcard">
                            <div className="d-flex flex-column flex-sm-row ">
                                <div className="box-1 text-center">FINISH</div>
                                <div className="box-2 flex-fill">Glossy, Matte, Glitter</div>
                            </div>
                        </Col>
                        <Col xs={12}sm={12} md={6} lg={6} className="ecoduramodular-textcard">
                            <div className="d-flex flex-column flex-sm-row ">
                                <div className="box-1 text-center">TEXTURE</div>
                                <div className="box-2 flex-fill">Wooden, Metallic, Colours</div>
                            </div>
                        </Col>
                        {/* <Col sm={12} md={6} lg={4} className="ecoduramodular-textcard">
                            <div className="d-flex flex-column flex-sm-row ">
            ...
            {/* <section>
                <Container>
                    <Row>
                        <Col sm={12} md={6} lg={4} className="ecoduramodular-image">
